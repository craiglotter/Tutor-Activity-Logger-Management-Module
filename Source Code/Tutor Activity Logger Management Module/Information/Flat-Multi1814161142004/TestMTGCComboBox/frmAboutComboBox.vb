...
#End Region
    ...
    Private Sub frmAboutComboBox_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        lblVersione.Text = "MTGCComboBox for .NET, Version " & System.Reflection.Assembly.LoadFrom(Application.StartupPath & "\MTGCComboBox.DLL").GetName.Version.ToString
